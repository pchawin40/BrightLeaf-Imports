...
export default function NavHeaderProvider({ children }) {
  ...
  const changeBackground = () => {
    ...
    if (backgroundColorCondition) {
      ...
      // if not shopProduct
      else if (!["shopproduct", "store-policy", "shipping-returns", "account-menu", "rnf"].includes(currentPage)) {
  ...
  const changeFooterColor = () => {
    ...
    if (["store-policy", "shopproduct", "shipping-returns", "account-menu", "rnf"].includes(currentPage)) {
